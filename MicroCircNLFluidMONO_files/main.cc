...
int main(int argc, char *argv[]) {
 ...
 try {   
    ...
    std::ofstream statistics( "./Vtk/Secomb93b/18mar/statisticslc025.txt" ); 
    ...
    sprintf(str_tF, "./Vtk/Secomb93b/18mar/Ptlc025.vtk");
    sprintf(str_vF, "./Vtk/Secomb93b/18mar/Pvlc025.vtk");
    sprintf(str_gradPt, "./Vtk/Secomb93b/18mar/gradPtlc025.vtk");
    sprintf(str_gradPv, "./Vtk/Secomb93b/18mar/gradPvlc025.vtk");
    sprintf(str_Ut, "./Vtk/Secomb93b/18mar/Utlc025.vtk");
    sprintf(str_Uv, "./Vtk/Secomb93b/18mar/Uvlc025.vtk");
